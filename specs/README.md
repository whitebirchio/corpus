...
5. [Nutrition accuracy](05-nutrition-accuracy/SPEC.md) — accurate meal logging as Corpus replaces MacroFactor: a photo + caption estimation protocol (new `log_meal_conversation` prompt, shipped 2026-07-18), then a personal food catalog + saved recipes with USDA FoodData Central / Open Food Facts lookups (phase 2, designed), then PWA barcode scanning as the PWA's first write surface (phase 3, designed).
