/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 968c3f64a6e7c9aa5f70bc5af522d43b)
// Runtime types generated with workerd@1.20260630.1 2026-06-01 nodejs_compat
interface __BaseEnv_Env {
	OAUTH_KV: KVNamespace;
	DOCS: R2Bucket;
	ALLOWED_EMAILS: "scott.schmalz@gmail.com";
	DEFAULT_TIMEZONE: "America/New_York";
	PUBLIC_BASE_URL: "";
	DATABASE_URL: string;
	CORPUS_APP_DB_PASSWORD: string;
	OAUTH_CLIENT_ID: string;
	OAUTH_CLIENT_SECRET: string;
	CLOUDFLARE_API_TOKEN: string;
	MCP_OBJECT: DurableObjectNamespace<import("./src/index").CorpusMcpAgent>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "CorpusMcpAgent";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_EMAILS" | "DEFAULT_TIMEZONE" | "PUBLIC_BASE_URL" | "DATABASE_URL" | "CORPUS_APP_DB_PASSWORD" | "OAUTH_CLIENT_ID" | "OAUTH_CLIENT_SECRET" | "CLOUDFLARE_API_TOKEN">> {}
}
